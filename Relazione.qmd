...
### 4.1.2 Classificazione a 7 gesti

Per considerare bene i rsultati ottenuti è necessario inanzitutto definire quali sono i gesti analizzati: 0-mano a riposo, 1-mano a pugno, 2-flessione del polso, 3-estensione del polso, 4-deviazioni radiali, 5-deviazioni ulnirali e 7-mano aperta. L'ultima configurazione non è stata svolta da tutti i partecipanti, perciò l'accuratezza calerà per quella determinata configurazione.
...
![](Images/Confusion_matrix_Lenet1D-3C.png)

#### 2° Modello $\implies$ Lenet1D-2C

![](Images/Confusion_matrix_Lenet1D-2C.png)

#### 3° Modello $\implies$ Multi-Scale1D

![](Images/Confusion_matrix_Multi-Scale1D.png)
